...
public class App {
    ...
    public static void main(String[] args) {
         ...
         * 
         * Loop fusion (optimization): filter() and map() are different operations,
         * they are merged into the same pass.
         * 
         * Short-circuiting: some operations don't need to process the whole stream
         * to produce a result, here we are looking for just 2 items - so the algorithm
